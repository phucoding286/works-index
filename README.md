...
- **NLP Datasets/Tools**
  - Các module xử lý dữ liệu văn bản hoặc crawl.
    ...
    - [Bot crawl hoàn chỉnh.](https://github.com/phucoding286/script-crawl) (Created by Phu)
...
- [Link đến repo của dự án.](https://github.com/phucoding286/my-web-project) (Đang phát triển theo thời gian, chưa ưu tiên.)
